...
class _HistoryPageState extends State<HistoryPage> {
    ...
    return Scaffold(
      ...
      body: BlocConsumer<HistoryBloc, HistoryState>(
        listener: (context, state) {
          ...
          final selectedDateChanged = _lastSelectedDate == null ||
              !_isSameDay(_lastSelectedDate!, selectedDate);

          final selectedActivityChanged =
  ...
  void _focusSelectedDayContent() {
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      final targetContext = _historyDayContentKey.currentContext;
