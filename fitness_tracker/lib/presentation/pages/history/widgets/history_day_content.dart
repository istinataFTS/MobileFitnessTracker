          ...
          : BlocBuilder<ExerciseBloc, ExerciseState>(
              builder: (context, exerciseState) {
                ...
                final exerciseMap = <String, Exercise>{
                  for (final exercise in exerciseState.exercises)
                    exercise.id: exercise,
                };

                final visibleSets = sets
                    .where((set) => exerciseMap.containsKey(set.exerciseId))
                    .toList();
...
class _NutritionHistorySection extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final totals = _NutritionTotals.fromLogs(logs);
