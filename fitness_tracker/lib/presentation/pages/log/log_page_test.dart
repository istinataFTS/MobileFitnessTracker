...
import 'package:fitness_tracker/presentation/pages/log/log_page.dart';
...
void main() {
  ...
  group('LogPage', () {
    testWidgets('renders segmented tabs', (tester) async {
      ...
      expect(find.text(AppStrings.logExerciseTab), findsOneWidget);
      expect(find.text(AppStrings.logMealTab), findsOneWidget);
      expect(find.text(AppStrings.logMacrosTab), findsOneWidget);
    });
    ...
    testWidgets('switches tabs when tapped', (tester) async {
      ...
      await tester.tap(find.text(AppStrings.logMealTab));
      await tester.pumpAndSettle();

      expect(find.text(AppStrings.logMealTab), findsWidgets);

      await tester.tap(find.text(AppStrings.logMacrosTab));
      await tester.pumpAndSettle();

      expect(find.text(AppStrings.logMacrosTab), findsWidgets);
    });

    testWidgets('reacts to workout logged effect by refreshing related blocs',
        (tester) async {
